...
if __name__ == "__main__":
    ...
    ensembled = tf.reduce_sum(labels_dist.sample(num_particle), axis=0, keepdims=False) / num_particle
    ...
    ensembled_pred = tf.reduce_sum(labels_dist_pred.sample(num_particle), axis=0, keepdims=False) / num_particle
    ...
    ensembled_grid = tf.reduce_sum(labels_dist_grid.sample(num_particle), axis=0, keepdims=False) / num_particle
